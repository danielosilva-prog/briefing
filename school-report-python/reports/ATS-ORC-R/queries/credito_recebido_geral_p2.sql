-- P02 CE G4: Crédito Recebido — TEDs + Bolsas CAPES + EBSERH Pessoal (2023–2026)
-- Tabela: tesouro_orcamento_destaque_recebido_instituicao + sandbox 2026 + bolsas_capes + ebserh_pessoal
...
-- UNNEST garante sempre 4 anos (2023–2026), preenchendo zeros para anos sem dados
...
dest_adj AS (
  SELECT ano, despesa_empenhada FROM dest_raw
  UNION ALL
  SELECT 2026, despesa_empenhada * 1.0426 FROM dest_raw WHERE ano = 2025
),
capes_raw AS (
