-- P02 G2: Visão Geral — Despesa Empenhada (2023–2026)
...
LEFT JOIN (
  SELECT
    t_uo.ano,
    SUM(CASE WHEN t_uo.ano < 2026 THEN t_uo.despesa_empenhada ELSE t_uo.dotacao_atualizada END) AS despesa_empenhada
