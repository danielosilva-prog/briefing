...
#let CreditoRecebidoPorDestaque(
  ...
  #hide[
    = Crédito Recebido por Destaque (Ministério da Educação)
  ]
  ...
  #place(bottom)[
    ...
    #grid(
      ...
      align(right)[
        ...
        MEC, INEP, CAPES, FNDE e EBSERH #destinatario (geralmente por meio de TED).
