...
#let CreditoRecebidoPorDestaque26291(
  // Destinatário
  destinatario: str,
  // Período 1 (2019-2021)
  p5CreditoRecebidoMedioPeriodo1: str,
  p5CreditoRecebidoAcumuladoPeriodo1: str,
  p5PercentVariacaoOrcamentoPeriodo1: str,
  p5PercentIPCAPeriodo1: str,
  // Periodo 2 (2023-2025)
  p5CreditoRecebidoMedioPeriodo2: str,
  p5CreditoRecebidoAcumuladoPeriodo2: str,
  p5IncrementoOrcamentario: str,
  p5PercentVariacaoOrcamentoPeriodo2: str,
  p5PercentIPCAPeriodo2: str,
  p5PercentIncrementoOrcamentario: str,
) = [

  #hide[
    = Crédito Recebido por Destaque (CAPES - UO 26291)
  ]
  ...
  #grid(
    ...
    align(left)[
      #grid(
        ...
        row-gutter: 4pt,
        Card(
          value: p5CreditoRecebidoMedioPeriodo1,
          legend: "Crédito Recebido Médio Anual\n(2019 - 2021)",
          backgroundColor: rgb("#FFCFA1"),
          color: rgb("#3C3C3C"),
        ),
        Card(
          value: p5CreditoRecebidoAcumuladoPeriodo1,
          legend: "Crédito Recebido Acumulado\n(2019 - 2021)",
          backgroundColor: rgb("#FFCFA1"),
          color: rgb("#3C3C3C"),
        ),
        Card(
          value: p5PercentVariacaoOrcamentoPeriodo1,
          legend: "Variação Orçamento\n(2019 - 2021)",
          backgroundColor: rgb("#FFCFA1"),
          color: rgb("#3C3C3C"),
        ),
        Card(
          value: p5PercentIPCAPeriodo1,
    ...
    align(right)[
      #grid(
        ...
        row-gutter: 4pt,
        Card(
          value: p5CreditoRecebidoMedioPeriodo2,
          legend: "Crédito Recebido Médio Anual\n(2023 - 2025)",
          backgroundColor: rgb("#FF7D00"),
        ),
        Card(
          value: p5CreditoRecebidoAcumuladoPeriodo2,
          legend: "Crédito Recebido Acumulado\n(2023 - 2025)",
          backgroundColor: rgb("#FF7D00"),
        ),
        Card(
          value: p5PercentVariacaoOrcamentoPeriodo2,
          legend: "Variação Orçamento\n(2023 - 2025)",
          backgroundColor: rgb("#FF7D00"),
        ),
        Card(
          value: p5PercentIPCAPeriodo2,
          legend: "IPCA Acumulado\n(2023- 2025)",
          backgroundColor: rgb("#FF7D00"),
        ),
        Card(
          value: p5IncrementoOrcamentario,
          legend: "Incremento\nOrçamentário",
          backgroundColor: rgb("#FF7D00"),
        ),
        Card(
          value: p5PercentIncrementoOrcamentario,
          legend: "% Incremento\nOrçamentário",
          backgroundColor: rgb("#FF7D00"),
        ),
      )
    ...
    #grid(
      ...
      align(right)[
        #text(
          ...
          pela CAPES (UO 26291) #destinatario (geralmente por meio de TED).
