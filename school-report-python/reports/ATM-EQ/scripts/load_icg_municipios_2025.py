"""Carrega a planilha ICG 2025 no sandbox.

Uso:
    uv run python reports/ATM-EQ/scripts/load_icg_municipios_2025.py
"""
...
def _schema() -> list[bigquery.SchemaField]:
    return [
        ...
        bigquery.SchemaField("icg_nivel_1", "FLOAT64"),
        bigquery.SchemaField("icg_nivel_2", "FLOAT64"),
        bigquery.SchemaField("icg_nivel_3", "FLOAT64"),
        bigquery.SchemaField("icg_nivel_4", "FLOAT64"),
        bigquery.SchemaField("icg_nivel_5", "FLOAT64"),
        bigquery.SchemaField("icg_nivel_6", "FLOAT64"),
...
def _locate_header_row(rows: list[list[str]]) -> int:
    for idx, row in enumerate(rows):
        if row and row[0] == "NU_ANO_CENSO" and row[-1] == "EDU_BAS_CAT_6":
            return idx
    raise RuntimeError("Cabecalho tecnico da planilha ICG nao encontrado.")
